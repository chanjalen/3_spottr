...
urlpatterns = [
    ...
    path('api/password-reset/request/', api_views.api_password_reset_request_view, name='api_password_reset_request'),
    path('api/password-reset/confirm/', api_views.api_password_reset_confirm_view, name='api_password_reset_confirm'),
    path('api/google-auth/', api_views.api_google_auth_view, name='api_google_auth'),
